...
api_url = "https://api.waterdata.usgs.gov/ogcapi/v0/collections/daily/items?limit=2&api_key=use-your-key&datetime=2025-09-01"  # Replace with the actual API URL
